                ...
                <div class="card h-100 row">
                    ...
                    <div class="card-body mx-5 px-5">
                        <div class="card-title">
                            <h4 class="text-success text-left">{{ 'Seu link de redefinição de senha' }}</h4>
                        </div>
                        <p class="mb-0">
                            {{ 'Você está recebendo este e-mail porque recebemos uma solicitação de redefinição de sua senha.' }}
                            <br>
                            {{ 'Para completar sua solicitação, clique no botão abaixo:' }}
                        </p>
                        <div class="p-3 text-center">
                            <a href="{{ $url }}" class="btn btn-success" role="button">Redefinir minha senha</a>
                        </div>
{{--                        <p class="mb-0">--}}
